...
function draw() {
    ...
    // let rects = elementGroup.selectAll('rect').data(data);
    // let texts = elementGroup.selectAll('text').data(data);
    let group = elementGroup.selectAll('g').data(data);
    group.join('g').call(updateGroup)
